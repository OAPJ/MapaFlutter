...
class MarkerInicioPainterPage extends CustomPainter {

  final int minutos;

  MarkerInicioPainterPage(this.minutos);
  ...
  bool shouldRepaint(MarkerInicioPainterPage oldDelegate) => false;

  @override
  
  bool shouldRebuildSemantics(MarkerInicioPainterPage oldDelegate) => false;
}